inScope(Global)(Seq(
  ...
  homepage := Some(url("https://github.com/lucidsoftware/lucid-util")),
  ...
  scmInfo := Some(ScmInfo(url("https://github.com/lucidsoftware/lucid-util"), "scm:git:git@github.com:lucidsoftware/lucid-util.git")),
